...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public class HDCamera
    {
        ...
        internal float probeCustomExposure
            => m_AdditionalCameraData != null
        ...
        public void SetupGlobalParams(CommandBuffer cmd, float time, float lastTime, int frameCount)
        {
            ...
            float exposureMultiplierForProbes = (probeCustomExposure == 1.0f ? 1.0f : ColorUtils.ConvertEV100ToExposure(probeCustomExposure));
